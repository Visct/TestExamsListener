...
public class OperationService {
    ...
    public void checkReceivedExam(EmailJmsModel emailJmsModel) throws IOException, MessagingException {
        checkTestsFromEmail(emailJmsModel);
        String examResult = testCheckService.examResult();
        emailSendService.sendSimpleMessage(examResult, emailJmsModel.getEmail());
...
//        POBIERANIE TESTU OD STUDENTA
        S3Object inboxGmailStudentFile = amazonClient.getObject(awsProperties.getBucketNameOfInboxExam2(), emailJmsModel.getAwsFileName());

//        POBRANIE TESTÓW DLA ROZWIĄZANYCH ZADAŃ OD STUDENTA
        S3Object testForExamFile = amazonClient.getObject(awsProperties.getBucketNameOfTests2(), emailJmsModel.getAwsTestFileName());
